...
if __name__ == '__main__':
    crop_and_resize_images(path='../data/train/', new_path='../data/train-resized-224/', cropx=1800, cropy=1800, img_size=224)
    crop_and_resize_images(path='../data/test/', new_path='../data/test-resized-224/', cropx=1800, cropy=1800, img_size=224)
